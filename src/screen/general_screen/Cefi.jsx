        ...
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <div className={styles.contentSection}>
                    ...
                    <p>
                        Unlike bank loans, CeFi loans typically require little or no paperwork. Via capchain, US-based customers in many states can borrow up to $100,000 without a credit check.
                    </p>
                ...
                <BulletList
                    text="Remember: crypto deposits aren’t currently eligible for the government-backed insurance that protects savings held by a traditional bank. (That said, capchain’s CeFi lending product offers a principal guarantee.)"
                />
                <BulletList
                    text="Some CeFi providers might lock up your principal for a period of time. capchain, however, allows you to access your USDC at any time. "
                />

                <BulletList
                    text="All stablecoins aren’t created equal. For example, USDC is based on open-source code that anyone can scrutinize. USDC is backed by dollar-denominated assets of at least equal fair value to the USDC in circulation, in segregated accounts with US regulated financial institutions. You can buy USDC via exchanges like capchain, and hold it in any Ethereum compatible wallet. There are no fees for transferring a US dollar to USDC. The launch of USDC was powered by a collaboration between capchain and Circle through the co-founding of the CENTRE Consortium."
                />
