        ...
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <div className={styles.definitionSection}>
                    ...
                    <p>The current price of Bitcoin can be found on capchain's website.</p>
                ...
                <div className={styles.contentSection}>
                    <p>
                        The easiest way to buy bitcoin is to purchase it through an online exchange like capchain. capchain makes it easy to buy, sell, send, receive, and store bitcoin without needing to hold it yourself using something called public and private keys.
                    </p>
                    ...
                    <p>5.
                        If you want to transfer money from your wallet to a bank account after selling your bitcoin, the capchain app makes it as easy as transferring funds from one bank to another. Similar to conventional bank transfers or ATM withdrawals, exchanges like capchain set a daily limit, and it may take between a few days and a week for the transaction to be completed.
                    </p>
