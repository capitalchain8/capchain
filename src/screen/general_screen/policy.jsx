    ...
    return (<>
        ...
        <div className={styles.content}>
            <div className={styles.innerContent}>
                ...
                <h1 className={styles.privacyHeading}>capchain Global Privacy Policy</h1>
                ...
                <p className={styles.paragraph}>
                    We at capchain (defined below) respect and protect the privacy of visitors to our websites and our customers. This Privacy Policy describes our information handling practices when you access our services,when you use the capchain mobile app, the capchain Card App (as defined below), any capchain, capchain Exchange, capchain Prime, or capchain Custody API or third party applications relying on such an API, and related services (referred to collectively hereinafter as "Services").
                ...
                <table className={styles.table}>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>capchain Custody International Limited (unless otherwise indicated in your service contract) Company No: 657718</td>
                        ...
                        <tr>
                            ...
                            <td>capchain Europe, Limited. Company No: 675475</td>
                        ...
                        <tr>
                            ...
                            <td>capchain Germany GmbH. Company No: HRB 213709 B. BaFin-ID 10158674</td>
                        ...
                        <tr>
                            ...
                            <td>capchain Ireland, Limited. Company No: 630350 CBI Register No: C188493</td>
                        ...
                        <tr>
                            ...
                            <td>capchain Singapore Pte. Ltd. Unique Entity No.: 201935002N</td>
                        ...
                        <tr>
                            ...
                            <td>capchain KK. Company No: 0100-01-173138 FSA Register No: Kanto Finance Bureau Directory-General No. 00028</td>
                        ...
                        <tr>
                            ...
                            <td>capchain Ascending Markets Kenya Limited (“CB Kenya”)</td>
                        ...
                        <tr>
                            ...
                            <td>capchain, Inc. CA Entity No.: C3548456</td>

                            <td>capchain, Inc. c/o C T Corporation System 818 West Seventh St., Ste. 930 Los Angeles, California 90017</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>capchain Custody Trust Company, LLC (unless otherwise indicated in your service contract) NYS License # 122506</td>

                            <td>capchain Custody Trust Company, LLC c/o C T Corporation System 28 Liberty Street New York, New York 10005</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>capchain Credit, Inc. CA Entity No.: C4315976</td>

                            <td>capchain Credit, Inc. c/o C T Corporation System 818 West Seventh St., Ste. 930 Los Angeles, California 90017</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>capchain Australia Pty Ltd; ACN 654 922 442</td>

                            <td>capchain Australia c/o TMF Corporate Services (Aust) Pty Limited, Suite 1 Level 11, 66 Goulburn Street, Sydney NSW 2000 Australia</td>
                        </tr>
                ...
                <p className={styles.paragraph}>
                    You may be asked to provide personal information anytime you are in contact with any CB companies. The CB companies may share your personal information with each other and use it consistent with this Privacy Policy. They may also combine it with other information to provide and improve our products, services, and content (additional details below). For example, even if you do not reside in the United States (the “US”), your information may be shared with capchain, Inc. which provides global support for all Services including technical infrastructure, product development, security, compliance, fraud prevention, and customer support..
                </p>
                <p className={styles.paragraph}>
                ...
                <div className={styles.bulletlist_con}>
                    ...
                    <p className={styles.paragraph}>
                        Our capchain Family of Companies: Our “family of companies” is the group of companies related to us by common control or ownership (“Affiliates”). In accordance with applicable law, we may obtain information about you from our Affiliates as a normal part of conducting business, if you link your various capchain accounts (e.g., capchain Wallet account or capchain Commerce account in order to convert cryptocurrency into fiat and make withdrawals into your bank account), so that we may offer our Affiliates’ Services to you.
                    </p>
                ...
                <p className={styles.paragraph}>(4) To provide capchain's Services</p>
                ...
                <p className={styles.paragraph}>
                    We process your personal information to better understand the way you use and interact with capchain's Services. In addition, we use such information to customize, measure, and improve capchain's Services and the content and layout of our website and applications, and to develop new services. Without such processing, we cannot ensure your continued enjoyment of our Services.
                </p>
                ...
                <table className={styles.table}>
                    ...
                    <tbody>
                        <tr>
                            <td> (2) To enforce our terms in our user agreement and other agreements (4) To provide capchain's Services (5) To provide Service communications (6) To provide customer service (7) To ensure quality control</td>
                ...
                <p className={styles.paragraph}>
                    If you authorize one or more third-party applications to access your CB Services, then information you have provided to CB may be shared with those third parties. A connection you authorize or enable between your CB account and a non-CB account, payment instrument, or platform is considered an “account connection.” Unless you provide further permissions, capchain will not authorize these third parties to use this information for any purpose other than to facilitate your transactions using CB Services. Please note that third parties you interact with may have their own privacy policies, and CB is not responsible for their operations or their use of data they collect. Information collected by third parties, which may include such things as contact details, financial information, or location data, is governed by their privacy practices and capchain is not responsible for unauthorized third-party conduct. We encourage you to learn about the privacy practices of those third parties.
                ...
                <p className={styles.paragraph}>
                    We rely primarily on the European Commission’s Standard Contractual Clauses to facilitate the international and onward transfer of personal information collected in the European Economic Area (“EEA”), the United Kingdom and Switzerland (collectively “European Personal Information”), to the extent the recipients of the European Personal Information are located in a country that the EU considers to not provide an adequate level of data protection. This includes transfers from our EU-based CB operating entities to our US-based operating entity, capchain, Inc. We may also rely on an adequacy decision of the European Commission confirming an adequate level of data protection in the jurisdiction of the party receiving the information, or derogations in specific situations.
                </p>
                <p className={styles.paragraph}>
                    capchain, Inc. is responsible for the processing of personal information it receives and subsequently transfers to a third party acting as an agent on its behalf. Before we share your information with any third party, capchain, Inc. will enter into a written agreement that the third party provides at least the same level of protection for the personal information as required under applicable data protection laws.
                </p>
                <p className={styles.paragraph}>
                    capchain, Inc., also participates in and has certified its compliance with the EU-US Privacy Shield Framework. Under the Privacy Shield Framework, capchain, Inc. is subject to the authority of the Federal Trade Commission.
