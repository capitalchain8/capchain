    ...
    return (<>
        ...
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <BulletList
                    text="You can check the latest prices on capchain's Ethereum asset page."
                />
                ...
                <BulletList
                    text="Wallet: To store and secure your Ether you’ll need a wallet. If you’re just starting out, the easiest option is to make an account via the capchainp app or capchain.cloud — in which case you’ll interact with a “custodial wallet” that stores and secures your private keys for you. As you progress you might want to investigate other wallet options that are built for interacting with decentralized finance (or DeFi) protocols such as Compound (a lending and savings app) or Uniswap (a decentralized exchange that allows you to trade cryptocurrencies)."
