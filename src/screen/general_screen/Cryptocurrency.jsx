    ...
    return (<>
        ...
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <div className={styles.contentSection}>
                    <p>
                        Online exchanges like capchain have made buying and selling cryptocurrencies easy, secure, and rewarding.
                    </p>
                </div>
                ...
                <BulletList
                    text="On capchain, you can earn 1% APY on— that’s much higher than most traditional savings accounts."

                />
                <BulletList
                    text="You can also earn up to 5% APY when you stake Tezos on capchain. Learn more about Tezos staking rewards."
                ...
                <div className={styles.contentSection}>
                    <p>The easiest way to acquire cryptocurrency is to purchase on an online exchange like capchain.</p>
                </div>

                <BulletList
                    text="On capchain, you can buy major cryptocurrencies like
                    Bitcoin (BTC), Litecoin (LTC), Ethereum (ETH), Bitcoin Cash (BCH), Ethereum Classic (ETC). Or you can explore emerging coins like Stellar Lumens or EOS. For some cryptocurrencies capchain offers opportunities to earn some for free.)"
                ...
                />
                <BulletList
                    text="Keep in mind that you do not need to buy a whole coin. On capchain, you can buy portions of coins in increments as little as 2 dollars, euros, pounds, or your local currency."
                ...
                <div className={styles.contentSection}>
                    <p>Storing crypto is similar to storing cash, which means you need to protect it from theft and loss. There are many ways to store crypto both online and off, but the simplest solution is via a trusted, secure exchange like capchain.</p>
                </div>

                <BulletList
                    text="capchain customers can securely store, send, receive, and convert crypto by signing into their account on a computer, tablet, or phone."
                />
                <BulletList
                    text="Want to transfer money from your wallet to a bank account? The capchain app makes it as easy as transferring funds from one bank to another. (Much like conventional bank transfers or ATM withdrawals, exchanges like capchain set a daily limit, and it might take from a few days to a week for the transaction to be completed."
                ...
                <BulletList
                    text="Shop: Over 8,000 global merchants accept cryptocurrency via capchain Commerce."
