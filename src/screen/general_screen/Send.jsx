        ...
        <div className={styles.content}>
            <div className={styles.leftContent}>
                ...
                <div className={styles.contentSection}>
                    ...
                    <BulletList
                        text="If you’re a capchain customer, you can also send crypto to any email address in 100+ countries instantly and for free. Just open your capchain app, select the crypto and an amount, enter the recipient’s email address, and hit send." />
