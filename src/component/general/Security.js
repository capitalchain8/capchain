...
function Security() {
    ...
    return (<div className={styles.security_section}  >
        <SectionHead title="The most trusted cryptocurrency platform" paragraph="Here are a few reasons why you should choose capchain" />
        <div className={styles.security_Con}>
            <div className={styles.security_card} data-aos="fade-up" >
                ...
                <div className={styles.security_content} >
                    ...
                    <a>Learn how capchain keeps your funds safe and secure <span className="material-icons">
                        arrow_forward
                    </span></a>
            ...
            <div className={styles.security_card} data-aos="fade-up" >
                ...
                <div className={styles.security_content}>
                    ...
                    <p> capchain maintains crypto insurance and all USD cash balances are covered by FDIC insurance, up to a maximum of $250,000.</p>
            ...
            <div className={styles.security_card} data-aos="fade-up" >
                ...
                <div className={styles.security_content}>
                    ...
                    <p>capchain supports a variety of the most popular digital currencies.</p>
                    <a>
